  ...
  $start_page = $paged - $half_page_start;
	...
	<nav class="page-navigation">
		...
		<?php if( $end_page < $max_page ) : ?>
			<li><a href="<?php echo get_pagenum_link( $max_page, true ); ?>" title="<?php echo esc_attr( $last_page_text ); ?>" aria-label="<?php echo esc_attr( __( 'Last page', 'sage' ) ); ?>"><?php _e( 'Last', 'sage' ); ?></a></li>
		<?php endif; ?>
	</ul></nav>
	<?php echo $after;
}
